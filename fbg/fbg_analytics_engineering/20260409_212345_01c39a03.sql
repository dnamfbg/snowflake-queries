-- Query ID: 01c39a03-0212-6dbe-24dd-070319351e73
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: unknown
-- Warehouse: TABLEAU_L_PROD
-- Executed: 2026-04-09T21:23:45.447000+00:00
-- Elapsed: 11685ms
-- Environment: FBG
...
WHERE ((NOT ("Custom SQL Query"."EVENT_NAME" IS NULL)) AND (NOT ("Custom SQL Query"."PROVIDER" IS NULL)) AND (NOT ("Custom SQL Query"."SPORT" IS NULL)) AND ("Custom SQL Query"."VIP_ACTIVE_ON_MARKET" IN (0, 1)) AND (("Custom SQL Query"."EVENT_DATE_ET" = '2026-04-10'::DATE) OR ("Custom SQL Query"."EVENT_DATE_ET" IS NULL)))
GROUP BY 1,
  2,
  3,
  4,
