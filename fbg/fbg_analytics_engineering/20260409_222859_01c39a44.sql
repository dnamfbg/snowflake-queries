-- Query ID: 01c39a44-0212-6dbe-24dd-070319441c03
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: unknown
-- Warehouse: TABLEAU_L_PROD
-- Executed: 2026-04-09T22:28:59.404000+00:00
-- Elapsed: 97523ms
-- Environment: FBG

SELECT DATE_TRUNC('SECOND',"Custom SQL Query"."MAX_BET_MODIFIED_DATE") AS "tsc:MAX_BET_MODIFIED_DATE:ok"
FROM (
  WITH stage_1 AS (
      SELECT
