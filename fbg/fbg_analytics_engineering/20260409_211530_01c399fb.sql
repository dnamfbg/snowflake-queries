-- Query ID: 01c399fb-0212-6e7d-24dd-070319333cc3
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: unknown
-- Warehouse: TABLEAU_L_PROD
-- Executed: 2026-04-09T21:15:30.732000+00:00
-- Elapsed: 58747ms
-- Environment: FBG
...
WHERE ((NOT ("Custom SQL Query"."EVENT_NAME" IS NULL)) AND (NOT ("Custom SQL Query"."PROVIDER" IS NULL)) AND (NOT ("Custom SQL Query"."SPORT" IS NULL)) AND ("Custom SQL Query"."VIP_ACTIVE_ON_MARKET" IN (0, 1)))
GROUP BY 1,
  2,
  3,
  4,
