-- Query ID: 01c39a65-0212-67a9-24dd-0703194b21f3
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: unknown
-- Warehouse: BI_SM_WH
-- Last Executed: 2026-04-09T23:01:30.483000+00:00
-- Elapsed: 7492ms
-- Run Count: 3
-- Environment: FBG
...
FROM (
  ...
  AND u.acquisition_bonus_name in ('Bet $30 Get $300 Sequenced','Bet $30 Get $300 Sequenced Bonus Bets','Bet $30 Get $300 Bonus Bets Sequenced')
  ...
  WHERE c.case_subtype = ('Bet $30 Get $300')
