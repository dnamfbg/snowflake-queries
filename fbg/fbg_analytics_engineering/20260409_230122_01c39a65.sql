-- Query ID: 01c39a65-0212-67a9-24dd-0703194b208f
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: unknown
-- Warehouse: BI_SM_WH
-- Last Executed: 2026-04-09T23:01:22.349000+00:00
-- Elapsed: 3503ms
-- Run Count: 3
-- Environment: FBG
...
FROM (
  ...
  AND u.acquisition_bonus_name IN ('3 x 100% Profit Boost Sequenced')
  ...
  WHERE c.case_subtype = ('3 x 100% Profit Boost Token')
