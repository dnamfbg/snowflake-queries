-- Query ID: 01c39a44-0212-6cb9-24dd-0703194453db
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: unknown
-- Warehouse: TABLEAU_L_PROD
-- Executed: 2026-04-09T22:28:46.296000+00:00
-- Elapsed: 107636ms
-- Environment: FBG
...
WHERE ((NOT ("Custom SQL Query"."EVENT_NAME" IS NULL)) AND (NOT ("Custom SQL Query"."PROVIDER" IS NULL)) AND ("Custom SQL Query"."SPORT" = 'MLB') AND ("Custom SQL Query"."VIP_ACTIVE_ON_MARKET" IN (0, 1)) AND ((("Custom SQL Query"."EVENT_DATE_ET" >= '2026-04-01'::DATE) AND ("Custom SQL Query"."EVENT_DATE_ET" <= '2026-04-10'::DATE)) OR ("Custom SQL Query"."EVENT_DATE_ET" IS NULL)))
GROUP BY 1,
  2,
  3,
  4,
