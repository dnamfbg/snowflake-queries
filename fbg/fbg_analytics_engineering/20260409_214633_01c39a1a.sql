-- Query ID: 01c39a1a-0212-67a8-24dd-0703193b200b
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: TRADING
-- Warehouse: BI_SER_XL_WH
-- Executed: 2026-04-09T21:46:33.476000+00:00
-- Elapsed: 2260ms
-- Environment: FBG
...
WHERE
    ...
    DATE(CONVERT_TIMEZONE('UTC', 'America/Los_Angeles', leg_event_time_utc)) BETWEEN '2025-03-18' AND '2025-09-29'
