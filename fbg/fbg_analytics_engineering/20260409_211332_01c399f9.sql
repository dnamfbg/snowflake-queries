-- Query ID: 01c399f9-0212-67a9-24dd-0703193302b7
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: unknown
-- Warehouse: TABLEAU_L_PROD
-- Executed: 2026-04-09T21:13:32.418000+00:00
-- Elapsed: 24796ms
-- Environment: FBG

SELECT "Custom SQL Query"."COMPETITION" AS "COMPETITION",
  ...
  SUM("Custom SQL Query"."MARKET_UNSETTLED_HANDLE") AS "sum:MARKET_UNSETTLED_HANDLE:ok",
  SUM("Custom SQL Query"."UNSETTLED_HANDLE") AS "sum:UNSETTLED_HANDLE:ok",
  SUM("Custom SQL Query"."UNSETTLED_VIP_HANDLE") AS "sum:UNSETTLED_VIP_HANDLE:ok"
FROM (
  WITH stage_1 AS (
      SELECT
...
WHERE ((NOT ("Custom SQL Query"."EVENT_NAME" IS NULL)) AND (NOT ("Custom SQL Query"."PROVIDER" IS NULL)) AND (NOT ("Custom SQL Query"."SPORT" IS NULL)) AND ("Custom SQL Query"."VIP_ACTIVE_ON_MARKET" IN (0, 1)) AND ((("Custom SQL Query"."EVENT_DATE_ET" >= '2026-04-10'::DATE) AND ("Custom SQL Query"."EVENT_DATE_ET" <= '2027-11-29'::DATE)) OR ("Custom SQL Query"."EVENT_DATE_ET" IS NULL)))
GROUP BY 1,
  2,
  3,
  4,
