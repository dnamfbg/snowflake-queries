-- Query ID: 01c39a2a-0212-67a8-24dd-0703193e3af7
-- Database: FBG_ANALYTICS_ENGINEERING
-- Schema: unknown
-- Warehouse: BI_SM_WH
-- Last Executed: 2026-04-09T22:02:22.498000+00:00
-- Elapsed: 1073ms
-- Run Count: 2
-- Environment: FBG
...
FROM (
  ...
  AND u.acquisition_bonus_name IN ('10 x 100% Profit Boost Sequenced')
  ...
  WHERE c.case_subtype = ('10 x 100% Profit Boost Token')
