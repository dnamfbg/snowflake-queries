-- Query ID: 01c39a4e-0212-6dbe-24dd-0703194658ff
-- Database: FBG_ANALYTICS_DEV
-- Schema: GHIBRIAN_AVILA
-- Warehouse: BI_L_WH
-- Executed: 2026-04-09T22:38:58.893000+00:00
-- Elapsed: 105737ms
-- Environment: FBG
...
used_base AS (
    SELECT
        ...
        CASE
            WHEN PARSE_JSON(p.data):Bonus:bonusCode::STRING ILIKE '%CAS_LC_PUNCH%'
              OR PARSE_JSON(p.data):Bonus:name::STRING ILIKE '%Casino Punch Card%'
                THEN 'Casino Punch Card'
...
eligible_final AS (
    ...
    SELECT DISTINCT
        ...
        NULL AS bonus_code,
        NULL AS bonus_name,
        'Casino Punch Card' AS promo_group,
        0 AS used_flag,
        1 AS eligible_flag
    FROM FBG_SOURCE.OSB_SOURCE.ACCOUNT_SEGMENTS a
    LEFT JOIN vt
