-- Query ID: 01c399f5-0212-6e7d-24dd-07031931c96b
-- Database: FBG_ANALYTICS
-- Schema: CASINO
-- Warehouse: BI_L_WH
-- Executed: 2026-04-09T21:09:45.385000+00:00
-- Elapsed: 928ms
-- Environment: FBG

create or replace temporary table "FBG_ANALYTICS"."CASINO"."DBT_MODELS__tmp_20260409210945372499"
         as
        (
        SELECT
