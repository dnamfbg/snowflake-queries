-- Query ID: 01c39a3a-0212-6cb9-24dd-0703194228af
-- Database: FBG_ANALYTICS
-- Schema: unknown
-- Warehouse: BI_XL_WH
-- Executed: 2026-04-09T22:18:12.920000+00:00
-- Elapsed: 23243ms
-- Environment: FBG
...
FROM (
  ...
  base_data AS (
      ...
      WHERE a.as_of_date IN ('2025-06-30', '2025-09-30', CURRENT_DATE)
  ...
  SELECT DISTINCT
      ...
      tier_credit_points_capped
  FROM staging
  where fbg_name in ('Taylor OBrien','Darren OBrien','Chris Bukowski','Michael Del Zotto','Will Rolapp','Jamie Fitzsimmons','Matthew Fleisher', 'Michael Hermalyn', 'Robert Ferrara','Pete Donahue','Gregg Hiller','Dan Barzottini','Tim Riley','Dana White','Michael Bernstein','Kyle McQuillan')
