-- Query ID: 01c39a2e-0212-67a9-24dd-0703193f459b
-- Database: FBG_ANALYTICS
-- Schema: unknown
-- Warehouse: BI_XL_WH
-- Executed: 2026-04-09T22:06:34.390000+00:00
-- Elapsed: 5963ms
-- Environment: FBG

SELECT "Custom SQL Query"."COHORT_SIZE" AS "COHORT_SIZE",
  "Custom SQL Query"."ELIGIBLE_VIP_COUNT" AS "ELIGIBLE_VIP_COUNT",
  "Custom SQL Query"."PERCENTAGE_TO_TARGET" AS "PERCENTAGE_TO_TARGET",
  "Custom SQL Query"."RANK" AS "RANK",
  "Custom SQL Query"."TOTAL_POINTS" AS "TOTAL_POINTS",
  "Custom SQL Query"."TOTAL_POSSIBLE_POINTS" AS "TOTAL_POSSIBLE_POINTS",
  "Custom SQL Query"."TOTAL_WEEKEND_1_POINTS" AS "TOTAL_WEEKEND_1_POINTS",
  "Custom SQL Query"."TOTAL_WEEKEND_2_POINTS" AS "TOTAL_WEEKEND_2_POINTS",
  "Custom SQL Query"."VIP_COUNT" AS "VIP_COUNT",
