-- Query ID: 01c39a2e-0212-6dbe-24dd-0703193f620b
-- Database: FBG_ANALYTICS
-- Schema: unknown
-- Warehouse: BI_XL_WH
-- Executed: 2026-04-09T22:06:11.852000+00:00
-- Elapsed: 13191ms
-- Environment: FBG

SELECT "Custom SQL Query"."COHORT_SIZE" AS "COHORT_SIZE",
  "Custom SQL Query"."TOTAL_WEEKEND_2_POINTS" AS "TOTAL_WEEKEND_2_POINTS",
  "Custom SQL Query"."TOTAL_WK2_POSSIBLE_POINTS" AS "TOTAL_WK2_POSSIBLE_POINTS",
  "Custom SQL Query"."USERS_ELIGIBLE_FOR_ACTIVATION" AS "USERS_ELIGIBLE_FOR_ACTIVATION",
  "Custom SQL Query"."VIP_HOST" AS "VIP_HOST",
  "Custom SQL Query"."WK2_REACTIVATION_PERCENTAGE" AS "WK2_REACTIVATION_PERCENTAGE"
FROM (
