-- Query ID: 01c39a2a-0212-6dbe-24dd-0703193e2f43
-- Database: FBG_ANALYTICS
-- Schema: unknown
-- Warehouse: BI_L_WH
-- Executed: 2026-04-09T22:02:20.268000+00:00
-- Elapsed: 1626ms
-- Environment: FBG

SELECT "Custom SQL Query6"."ACCO_ID" AS "ACCO_ID (Custom SQL Query6)",
  "Custom SQL Query6"."ACTIVE_DAYS_0_TO_30_POST_END" AS "ACTIVE_DAYS_0_TO_30_POST_END",
  "Custom SQL Query6"."ACTIVE_DAYS_IN_FAST_TRACK" AS "ACTIVE_DAYS_IN_FAST_TRACK",
  "Custom SQL Query6"."FAST_TRACK_START_DATE" AS "FAST_TRACK_START_DATE (Custom SQL Query6)",
  "Custom SQL Query6"."TYPE" AS "TYPE (Custom SQL Query6)"
FROM (
