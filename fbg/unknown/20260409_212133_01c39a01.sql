-- Query ID: 01c39a01-0212-6cb9-24dd-07031934e6d7
-- Database: unknown
-- Schema: unknown
-- Warehouse: BI_XL_WH
-- Executed: 2026-04-09T21:21:33.161000+00:00
-- Elapsed: 83588ms
-- Environment: FBG
...
, case when lm.lead_source = 'Direct' and lm.lead_subsource != 'Direct' and lm.lead_source != 'Referral' then true else false end as is_direct 
...
, case when is_direct = false and pe.lead_id is null and lic.lead_id is null and c.lead_id is null and d.acco_id is null and lm.lead_status != 'Disqualified' then true else false end as is_reassignment_eligible
