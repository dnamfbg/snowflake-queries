-- Query ID: 01c39a2d-0212-67a9-24dd-0703193edcef
-- Database: unknown
-- Schema: unknown
-- Warehouse: BI_XSM_WH
-- Executed: 2026-04-09T22:05:11.684000+00:00
-- Elapsed: 27755ms
-- Environment: FBG
...
, ledger_temp as (
    ...
    LEFT JOIN  FBG_P13N.PROMO_SILVER_TABLE.PROMOTIONS_LEDGER_FINAL u
            ...
            and ("Bonus Category" in ('CS Acquisition','Acquisition') or "SubCategory" = 'Migration')
