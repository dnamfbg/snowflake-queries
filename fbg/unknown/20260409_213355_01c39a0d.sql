-- Query ID: 01c39a0d-0212-67a8-24dd-0703193811db
-- Database: unknown
-- Schema: unknown
-- Warehouse: BI_SER_L_WH
-- Executed: 2026-04-09T21:33:55.036000+00:00
-- Elapsed: 43942ms
-- Environment: FBG
...
WITH email_cases AS (
  ...
  WHERE c.case_closed_est IS NOT NULL
    AND (DATE(CONVERT_TIMEZONE('UTC','America/New_York', c.case_closed_est)) >= ('2026-04-08 21:33:54')::timestamp AND DATE(CONVERT_TIMEZONE('UTC','America/New_York', c.case_closed_est)) < ('2026-04-09 21:33:54')::timestamp) 
