-- Query ID: 01c399da-0212-644a-24dd-0703192bbdc3
-- Database: unknown
-- Schema: unknown
-- Warehouse: BI_M_WH
-- Executed: 2026-04-09T20:42:58.935000+00:00
-- Elapsed: 23236ms
-- Environment: FBG
...
and date(wager_settlement_time_alk) >= '2026-04-01'
and date(wager_settlement_time_alk) <= '2026-04-30'--current_date() --'2025-10-30'
...
OR (event_league ILIKE '%UEFA Champions%' AND event_sport_name ILIKE '%SOCCER%')
