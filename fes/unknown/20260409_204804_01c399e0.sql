-- Query ID: 01c399e0-0112-6806-0000-e307218a154a
-- Database: unknown
-- Schema: unknown
-- Warehouse: FDE_FES_ANALYST_XL_WH
-- Executed: 2026-04-09T20:48:04.828000+00:00
-- Elapsed: 7840ms
-- Environment: FES
...
select 
    ...
    from monterosa_fanapp_ids m
        left join fanapp_users pfi 
        on m.fanapp_tenant_fan_id = pfi.fanapp_tenant_fan_id
        where pfi.fanapp_tenant_fan_id is null;
