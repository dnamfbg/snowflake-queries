-- Query ID: 01c39a13-0112-6806-0000-e307218b6d02
-- Database: unknown
-- Schema: unknown
-- Warehouse: SNOWFLAKE_INTELLIGENCE_WH
-- Executed: 2026-04-09T21:39:26.532000+00:00
-- Elapsed: 7366ms
-- Environment: FES
...
/*SELECT 
    ...
    WHEN profit_tier = 'Tier 5' THEN 'Tier 5'
    ELSE 'Tier 6' END AS rounded_profit_tier
...
FROM running_profit_tiers a
JOIN FANGRAPH.PRIVATE_FAN_ID.PFI_CUSTOMER_MART b 
    ON a.private_fan_id = b.private_fan_id
LEFT JOIN FBG_FDE.FBG_USERS.V_FBG_CUSTOMER_MART c 
    ON b.fbg_acco_id = c.acco_id
    AND status = 'ACTIVE'
GROUP BY ALL
ORDER BY 
    CASE profit_tier 
