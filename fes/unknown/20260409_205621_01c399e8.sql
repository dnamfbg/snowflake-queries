-- Query ID: 01c399e8-0112-65b6-0000-e307218a3576
-- Database: unknown
-- Schema: unknown
-- Warehouse: FDE_FES_ANALYST_XL_WH
-- Executed: 2026-04-09T20:56:21.416000+00:00
-- Elapsed: 8555ms
-- Environment: FES
...
select 
    pfi.private_fan_id, 
    monterosa_fanapp_tenant_fan_id, 
    ftp_first_game_ts_utc,
    ftu_source,
    fanapp_ftu_attribution
from fangraph.private_fan_id.pfi_customer_mart pfi
    inner join monterosa_only_ids m
        on fanapp_tenant_fan_id = monterosa_fanapp_tenant_fan_id
