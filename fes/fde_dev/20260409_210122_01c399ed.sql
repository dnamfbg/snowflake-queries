-- Query ID: 01c399ed-0112-6ccc-0000-e3072189eff6
-- Database: FDE_DEV
-- Schema: FDE_STAGE
-- Warehouse: FDE_DEVELOPER_XL_WH
-- Executed: 2026-04-09T21:01:22.128000+00:00
-- Elapsed: 17668ms
-- Environment: FES

INSERT OVERWRITE INTO fangraph_dev.private_fan_id.pfi_fbg_favorites (
            "PRIVATE_FAN_ID", "FBG_PREFERENCE_NFL", "FBG_PREFERENCE_NCAA", "FBG_PREFERENCE_NBA", "FBG_PREFERENCE_NHL", "FBG_PREFERENCE_MLB", "FBG_PREFERENCE_NFL_TEAMS", "FBG_PREFERENCE_NCAA_TEAMS", "FBG_PREFERENCE_NBA_TEAMS", "FBG_PREFERENCE_NHL_TEAMS", "FBG_PREFERENCE_MLB_TEAMS"
          )
          select
            
              __src."PRIVATE_FAN_ID", 
            
              __src."FBG_PREFERENCE_NFL", 
            
              __src."FBG_PREFERENCE_NCAA", 
            
              __src."FBG_PREFERENCE_NBA", 
            
              __src."FBG_PREFERENCE_NHL", 
            
              __src."FBG_PREFERENCE_MLB", 
            
              __src."FBG_PREFERENCE_NFL_TEAMS", 
            
              __src."FBG_PREFERENCE_NCAA_TEAMS", 
            
              __src."FBG_PREFERENCE_NBA_TEAMS", 
            
              __src."FBG_PREFERENCE_NHL_TEAMS", 
            
              __src."FBG_PREFERENCE_MLB_TEAMS"
            
          from ( WITH mdm_teams AS (
    SELECT DISTINCT
