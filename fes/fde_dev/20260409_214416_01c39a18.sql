-- Query ID: 01c39a18-0112-6bf9-0000-e307218be456
-- Database: FDE_DEV
-- Schema: FDE_STAGE
-- Warehouse: FDE_DEVELOPER_XL_WH
-- Executed: 2026-04-09T21:44:16.176000+00:00
-- Elapsed: 742ms
-- Environment: FES

select * from (
        -- step 1: get fangraph_id where it exists for topps customers by matching tenant_fan_id
WITH topps AS (
