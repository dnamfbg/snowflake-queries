-- Query ID: 01c399cd-0112-6f37-0000-e30721899c0e
-- Database: FDE_DEV
-- Schema: FDE_STAGE
-- Warehouse: FDE_DEVELOPER_XL_WH
-- Executed: 2026-04-09T20:29:39.115000+00:00
-- Elapsed: 4098ms
-- Environment: FES

select * from (
        WITH fbg_account_to_pfi AS (
    SELECT
