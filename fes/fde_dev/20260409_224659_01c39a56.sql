-- Query ID: 01c39a56-0112-6be5-0000-e307218d7576
-- Database: FDE_DEV
-- Schema: FDE_STAGE
-- Warehouse: FDE_DEVELOPER_XL_WH
-- Executed: 2026-04-09T22:46:59.215000+00:00
-- Elapsed: 48623ms
-- Environment: FES

INSERT OVERWRITE INTO fangraph_dev.private_fan_id.pfi_fbg_accounts (
            "PRIVATE_FAN_ID", "FBG_ACCOUNT_ID", "FBG_ACCOUNT_CREATION_TS", "FBG_LAST_MODIFIED_TS", "FBG_ACCOUNT_DELETED", "FBG_STATUS", "FBG_NAME", "FBG_FIRST_NAME", "FBG_LAST_NAME", "FBG_EMAIL", "FBG_ADDRESS1", "FBG_ADDRESS2", "FBG_TOWN", "FBG_STATE", "FBG_ZIP_CODE", "FBG_COUNTRY", "FBG_COUNTRY_CODE", "FBG_BET_LIMIT", "FBG_LIVE_BET_LIMIT", "FBG_CURRENT_JURISDICTIONS_ID", "FBG_JURISDICTION_NAME", "FBG_HIGH_LEVEL_SEGMENT", "FBG_SEGMENT", "FBG_IS_PB_USER", "FBG_IS_DATA_SHARING", "FBG_KYC_COMPLETED_TS", "FBG_VIP_ID", "FBG_VIP_TIERS", "FBG_VIP_TIER_MODIFIED_TS"
          )
          select
            
              __src."PRIVATE_FAN_ID", 
            
              __src."FBG_ACCOUNT_ID", 
            
              __src."FBG_ACCOUNT_CREATION_TS", 
            
              __src."FBG_LAST_MODIFIED_TS", 
            
              __src."FBG_ACCOUNT_DELETED", 
            
              __src."FBG_STATUS", 
            
              __src."FBG_NAME", 
            
              __src."FBG_FIRST_NAME", 
              ...
              __src."FBG_COUNTRY_CODE", 
            
              __src."FBG_BET_LIMIT", 
            
              __src."FBG_LIVE_BET_LIMIT", 
            
              __src."FBG_CURRENT_JURISDICTIONS_ID", 
            
              __src."FBG_JURISDICTION_NAME", 
            
              __src."FBG_HIGH_LEVEL_SEGMENT", 
            
              __src."FBG_SEGMENT", 
            
              __src."FBG_IS_PB_USER", 
            
              __src."FBG_IS_DATA_SHARING", 
            
              __src."FBG_KYC_COMPLETED_TS", 
            
              __src."FBG_VIP_ID", 
            
              __src."FBG_VIP_TIERS", 
            
              __src."FBG_VIP_TIER_MODIFIED_TS"
